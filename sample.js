...
export async function main() {
  ...
  const response = await client.path("/chat/completions").post({
    body: {
      messages: [
        { role: "system", content: "You are a front end web devloper." },
        { role: "user", content: [
            { type: "text", text: "Develop the front end of a web page  as shown in this sketch. Provide the code in HTML and CSS."},
